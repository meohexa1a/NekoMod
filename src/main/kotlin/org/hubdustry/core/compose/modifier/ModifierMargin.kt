...
fun Modifier.margin(all: Dp): Modifier = this.margin(all = all.toPx)
...
fun Modifier.margin(horizontal: Dp = 0.dp, vertical: Dp = 0.dp): Modifier =
    this.margin(horizontal = horizontal.toPx, vertical = vertical.toPx)
...
internal data class MarginModifier(
    val start: Float,
    val top: Float,
    val end: Float,
    val bottom: Float
